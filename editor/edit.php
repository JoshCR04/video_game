<?php 
    ...
    if($_GET) {
        $id = $_GET['id'];
        $data = $database->select("tb_game_config", "*", ["id_game_config" => $_GET['id']
    ]);
    ...
    <!-- Textarea, the code editor -->
     ...
     <div id="divCodeWrapper">
        ...
        <form action="./edit.php" method="POST">
            ...
            <input type="submit" value="Submit data" style="display: block; position:absolute; width:15%; bottom:1px; background:red; color:white; font-size:18px; height:40px; z-index: 10; right:50px; top:500px;">
        </form>
    </div>
